    ...
    return (
        <div className="dataBeautifyPanel">
            ...
            <div className="dataBeautifyPanelActions">
                <button className={styles.displayAdsPreviewBtn} type="button" onClick={encode}>Encode URL</button>
                <button className={styles.displayAdsPreviewBtn} type="button" onClick={decode}>Decode URL</button>
